...
<div id="wrap" >
    ...
    <div id="main_container">
        ...
        <div id="header" class="nothing">
            ...
            <div id="nav-menu">
				<ul>                                                                                            
                    ...
                    <li><a href="transport.php?num=0" class="current">Transport</a></li>
		...
		<form autocomplete="off" method="post" action="verification/rech-transport.php">
		...
		<center>
			...
			<img src="images/transport_example.jpg" width="400px"  style="box-shadow: 1px 1px 12px #555;"/> 
		</center>
		</div>
...
Destinataire : MG/Transport

Envoi demande le : <?php echo utf8_encode(strftime('%d %B %Y')); ?>


Prière autoriser <?php echo strtoupper($row2['nom']);?> <?php echo  ucfirst($row2['prenom']);?> à prendre le transport (STCR), il s'agit d'un stagiaire affecté à la Direction Technique jusqu'au <?php echo $row5['date_fin']; ?> .
...
Remerciements.
	...
	<center><input type="image" value="submit" src="images/pdf-telech.png" width="70px" height="70px" ></center><br/><br/>
	</form>
